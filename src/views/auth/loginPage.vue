...
-->
  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      <h1 class="text-center text-2xl font-bold text-gray-600 sm:text-2xl">
        Welcome to Edwin Watches
      </h1>

      <p class="mx-auto mt-4 max-w-md text-center text-gray-500">
        Type your e-mail or phone number and password to log in or create a Jumia account.
      </p>
