<template>
  <footer aria-label="Site Footer" class="bg-white">
    <div
      class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24"
    >
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <div
            class="flex font-black text-xl space-x-2 justify-center text-teal-600 sm:justify-start"
          >
            <img
              class="inline-block h-5 w-5"
              src="@/assets/img/latest_product_1.png"
              alt=" "
            />
            <span> Edwin Watches</span>
          </div>
